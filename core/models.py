...
class Job(models.Model):
    ...
    pickup_photo = models.ImageField(upload_to='jobs/pickup_photos/',null=True,blank=True)
    pickeup_at = models.DateTimeField(null=True,blank=True)
    
    delivery_photo = models.ImageField(upload_to='jobs/delivery_photos/',null=True,blank=True)
